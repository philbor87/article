# -*- coding: utf-8 -*-
"""
Created on Wed Nov 27 15:30:58 2024
...
dffiltre=df[df['PourcentageG1']>=40]
print(dffiltre)
...
basemodel=MLPRegressor(hidden_layer_sizes=18,max_iter=4000,random_state=42)
ada_model=AdaBoostRegressor(base_estimator=basemodel,n_estimators=100,random_state=42)
