# -*- coding: utf-8 -*-
"""
Created on Sun Dec 29 19:32:57 2024
...
model = DecisionTreeClassifier(random_state=42,max_depth=5,min_samples_leaf=1,criterion='gini')
...
#print(paramsdot
#dotdate=export_graphviz(model)
#graph=Source(dotdate)
#graph.render("arbre decision")
#graph.view()