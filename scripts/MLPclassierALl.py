# -*- coding: utf-8 -*-
"""
Created on Sun Dec 29 17:39:06 2024
...
model=MLPClassifier(activation= 'relu', alpha= 0.001, hidden_layer_sizes= (2,), learning_rate= 'adaptive', solver= 'adam',max_iter=2000,random_state=42)
